...
//SHTx
// SDA on port B, bit11 bit7
#define SDA_LOW(m)  	(GPIOB->BSRR = m?0x08000000:0x00800000) // set SDA to low
#define SDA_OPEN(m) 	(GPIOB->BSRR = m?0x00000800:0x00000080) // set SDA to open-drain
#define SDA_READ(m)   	(GPIOB->IDR &= m?0x0800:0x0080)     // read SDA

// SCL on port B, bit10  bit6             /* -- adapt the defines for your uC -- */
#define SCL_LOW(m)  	(GPIOB->BSRR = m?0x04000000:0x00400000) // set SCL to low
#define SCL_OPEN(m) 	(GPIOB->BSRR = m?0x00000400:0x00000040) // set SCL to open-drain
#define SCL_READ(m)   	(GPIOB->IDR &= m?0x0400:0x0040)     // read SCL
